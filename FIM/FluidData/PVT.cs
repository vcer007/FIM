...
namespace FIM.FluidData
{
    ...
    public class PVT
    {
        ...
        /// </remarks>
        /// <param name="oil_data">The oil_data.</param>
        /// <param name="oil_us_data">The oil_us_data.</param>
        /// <param name="water_data">The water_data.</param>
        /// <param name="water_us_data">The water_us_data.</param>
        /// <param name="gas_data">The gas_data.</param>
        /// <param name="bubble_point">The bubble_point.</param>
